...
1. http://vvv.dev for default vvv dashboard (www/default)
1. http://local.wordpress.dev for latest WordPress stable w PHP7 (www/wordpress-default)
1. http://baycare.dev for latest F4D theme with BayCare on WordPress stable w PHP7 (www/wp_baycare)
